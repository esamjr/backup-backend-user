...
urlpatterns = [
    ...
    url(r'^api/filter/$', views.get_all_hierarchy, name='get_all_hierarchy'),
    ...
    # url(r'^api/filter/(?P<pk+ hierarchy.id1>[0-9]+)/(?P<pk2>[0-9]+)$', views.get_all_hierarchy, name='get_all_hierarchy'),
]
